...
def test_lowest_shinsekai_version_is_optional_string() -> None:
    validate_registry([valid_entry(lowest_shinsekai_version=">=0.2.0")])

    with pytest.raises(RegistryValidationError, match="lowest_shinsekai_version"):
